...
//blog description              
$food_grocery_hub_mobile_blog_description = get_theme_mod('food_grocery_hub_mobile_blog_description', true);
$food_grocery_hub_tp_theme_css .= '@media screen and (max-width: 575px) {';
if ($food_grocery_hub_mobile_blog_description == false) {
    $food_grocery_hub_tp_theme_css .= '.blog-description{ display: none; }';
}
$food_grocery_hub_tp_theme_css .= '}';
...
// header
$food_grocery_hub_slider_arrows = get_theme_mod('food_grocery_hub_slider_arrows', true);
...
/*--------------------------- banner image Opacity -------------------*/
    $food_grocery_hub_theme_lay = get_theme_mod( 'food_grocery_hub_header_banner_opacity_color','0.5');
        if($food_grocery_hub_theme_lay == '0'){
            $food_grocery_hub_tp_theme_css .='.single-page-img, .featured-image{';
                $food_grocery_hub_tp_theme_css .='opacity:0';
            $food_grocery_hub_tp_theme_css .='}';
        }else if($food_grocery_hub_theme_lay == '0.1'){
            $food_grocery_hub_tp_theme_css .='.single-page-img, .featured-image{';
                $food_grocery_hub_tp_theme_css .='opacity:0.1';
            $food_grocery_hub_tp_theme_css .='}';
        }else if($food_grocery_hub_theme_lay == '0.2'){
            $food_grocery_hub_tp_theme_css .='.single-page-img, .featured-image{';
                $food_grocery_hub_tp_theme_css .='opacity:0.2';
            $food_grocery_hub_tp_theme_css .='}';
        }else if($food_grocery_hub_theme_lay == '0.3'){
            $food_grocery_hub_tp_theme_css .='.single-page-img, .featured-image{';
                $food_grocery_hub_tp_theme_css .='opacity:0.3';
            $food_grocery_hub_tp_theme_css .='}';
        }else if($food_grocery_hub_theme_lay == '0.4'){
            $food_grocery_hub_tp_theme_css .='.single-page-img, .featured-image{';
                $food_grocery_hub_tp_theme_css .='opacity:0.4';
            $food_grocery_hub_tp_theme_css .='}';
        }else if($food_grocery_hub_theme_lay == '0.5'){
            $food_grocery_hub_tp_theme_css .='.single-page-img, .featured-image{';
                $food_grocery_hub_tp_theme_css .='opacity:0.5';
            $food_grocery_hub_tp_theme_css .='}';
        }else if($food_grocery_hub_theme_lay == '0.6'){
            $food_grocery_hub_tp_theme_css .='.single-page-img, .featured-image{';
                $food_grocery_hub_tp_theme_css .='opacity:0.6';
            $food_grocery_hub_tp_theme_css .='}';
        }else if($food_grocery_hub_theme_lay == '0.7'){
            $food_grocery_hub_tp_theme_css .='.single-page-img, .featured-image{';
                $food_grocery_hub_tp_theme_css .='opacity:0.7';
            $food_grocery_hub_tp_theme_css .='}';
        }else if($food_grocery_hub_theme_lay == '0.8'){
            $food_grocery_hub_tp_theme_css .='.single-page-img, .featured-image{';
                $food_grocery_hub_tp_theme_css .='opacity:0.8';
            $food_grocery_hub_tp_theme_css .='}';
        }else if($food_grocery_hub_theme_lay == '0.9'){
            $food_grocery_hub_tp_theme_css .='.single-page-img, .featured-image{';
                $food_grocery_hub_tp_theme_css .='opacity:0.9';
            $food_grocery_hub_tp_theme_css .='}';
        }else if($food_grocery_hub_theme_lay == '1'){
            $food_grocery_hub_tp_theme_css .='#slider img{';
                $food_grocery_hub_tp_theme_css .='opacity:1';
            $food_grocery_hub_tp_theme_css .='}';
        }

    $food_grocery_hub_header_banner_image_overlay = get_theme_mod('food_grocery_hub_header_banner_image_overlay', true);
    if($food_grocery_hub_header_banner_image_overlay == false){
        $food_grocery_hub_tp_theme_css .='.single-page-img, .featured-image{';
            $food_grocery_hub_tp_theme_css .='opacity:1;';
        $food_grocery_hub_tp_theme_css .='}';
    }

    $food_grocery_hub_header_banner_image_ooverlay_color = get_theme_mod('food_grocery_hub_header_banner_image_ooverlay_color', true);
    if($food_grocery_hub_header_banner_image_ooverlay_color != false){
        $food_grocery_hub_tp_theme_css .='.box-image-page{';
            $food_grocery_hub_tp_theme_css .='background-color: '.esc_attr($food_grocery_hub_header_banner_image_ooverlay_color).';';
        $food_grocery_hub_tp_theme_css .='}';
    }