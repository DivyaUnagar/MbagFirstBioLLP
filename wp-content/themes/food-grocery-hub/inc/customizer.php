...
function Food_Grocery_Hub_Customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting('food_grocery_hub_edit_blog_page_title',array(
		'default'=> __('Home','food-grocery-hub'),
	...
	$wp_customize->add_setting('food_grocery_hub_edit_blog_page_description',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('food_grocery_hub_edit_blog_page_description',array(
		'label'	=> __('Add Blog Page Description','food-grocery-hub'),
		'section'=> 'food_grocery_hub_blog_option',
		'type'=> 'text'
	));
	...
	$wp_customize->add_setting('food_grocery_hub_footer_text',array(
		'default'	=> __('Food Grocery Hub WordPress Theme','food-grocery-hub'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	...
	$wp_customize->add_setting( 'food_grocery_hub_mobile_blog_description', array(
		'default'           => true,
		'transport'         => 'refresh',
		'sanitize_callback' => 'food_grocery_hub_sanitize_checkbox',
	) );
	$wp_customize->add_control( new food_grocery_hub_Toggle_Control( $wp_customize, 'food_grocery_hub_mobile_blog_description', array(
		'label'       => esc_html__( 'Show / Hide Blog Page Description', 'food-grocery-hub' ),
		'section'     => 'food_grocery_hub_mobile_media_option',
		'type'        => 'toggle',
		'settings'    => 'food_grocery_hub_mobile_blog_description',
	) ) );
    ...
    $wp_customize->add_control(
        ...
        //Opacity
	$wp_customize->add_setting('food_grocery_hub_header_banner_opacity_color',array(
       'default'              => '0.5',
       'sanitize_callback' => 'food_grocery_hub_sanitize_choices'
	));
    $wp_customize->add_control( 'food_grocery_hub_header_banner_opacity_color', array(
		'label'       => esc_html__( 'Header Image Opacity','food-grocery-hub' ),
		'section'     => 'header_image',
		'type'        => 'select',
		'settings'    => 'food_grocery_hub_header_banner_opacity_color',
		'choices' => array(
           '0' =>  esc_attr(__('0','food-grocery-hub')),
           '0.1' =>  esc_attr(__('0.1','food-grocery-hub')),
           '0.2' =>  esc_attr(__('0.2','food-grocery-hub')),
           '0.3' =>  esc_attr(__('0.3','food-grocery-hub')),
           '0.4' =>  esc_attr(__('0.4','food-grocery-hub')),
           '0.5' =>  esc_attr(__('0.5','food-grocery-hub')),
           '0.6' =>  esc_attr(__('0.6','food-grocery-hub')),
           '0.7' =>  esc_attr(__('0.7','food-grocery-hub')),
           '0.8' =>  esc_attr(__('0.8','food-grocery-hub')),
           '0.9' =>  esc_attr(__('0.9','food-grocery-hub'))
		), 
	) );

   $wp_customize->add_setting( 'food_grocery_hub_header_banner_image_overlay', array(
	    'default'   => true,
	    'transport' => 'refresh',
	    'sanitize_callback' => 'food_grocery_hub_sanitize_checkbox',
	));
	$wp_customize->add_control( new food_grocery_hub_Toggle_Control( $wp_customize, 'food_grocery_hub_header_banner_image_overlay', array(
	    'label'   => esc_html__( 'Show / Hide Header Image Overlay', 'food-grocery-hub' ),
	    'section' => 'header_image',
	)));

    $wp_customize->add_setting('food_grocery_hub_header_banner_image_ooverlay_color', array(
		'default'           => '#000',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'food_grocery_hub_header_banner_image_ooverlay_color', array(
		'label'    => __('Header Image Overlay Color', 'food-grocery-hub'),
		'section'  => 'header_image',
	)));
    ...
    $wp_customize->add_control(
        ...
        array(
            ...
            'section'     => 'header_image',
            'type'        => 'number',
            'description' => esc_html__( 'Control the font Size of the header image title. Default is 62px.', 'food-grocery-hub' ),
            'input_attrs' => array(
                'min'  => 10,
                'max'  => 200,
                'step' => 1,
...
if ( ! defined( 'FOOD_GROCERY_HUB_DOCS_URL' ) ) {
	define( 'FOOD_GROCERY_HUB_DOCS_URL', esc_url('https://page.themespride.com/demo/docs/food-grocery-hub-lite/'));
}

if ( ! defined( 'FOOD_GROCERY_HUB_DEMO_TITLE' ) ) {
	define( 'FOOD_GROCERY_HUB_DEMO_TITLE', esc_html__( 'Click to View Site', 'food-grocery-hub' ));
}
/**
...
final class Food_Grocery_Hub_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new food_grocery_hub_Customize_Section_Pro(
				$manager,
				'food_grocery_hub_documentation',
				array(
					'priority'   => 500,
					'title'    => esc_html__( 'Theme Documentation', 'food-grocery-hub' ),
					'pro_text' => esc_html__( 'Click Here', 'food-grocery-hub' ),
					'pro_url'  => esc_url( FOOD_GROCERY_HUB_DOCS_URL, 'food-grocery-hub'),
				)
			)
		);
		...
		$manager->add_section(
			new food_grocery_hub_Customize_Section_Pro(
				$manager,
				'food_grocery_hub_section_pro_demo',
				array(
					'priority'   => 9,
					'title'    => FOOD_GROCERY_HUB_DEMO_TITLE,
					'pro_text' => esc_html__( 'View Site', 'food-grocery-hub' ),
