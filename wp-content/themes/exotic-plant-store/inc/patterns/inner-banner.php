...
return array(
	...
	'content'    => '<!-- wp:group {"className":"inner-banner-wrap","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"},"margin":{"top":"0","bottom":"0"},"blockGap":"0"},"color":{"background":"#568b58"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group inner-banner-wrap has-background" style="background-color:#568b58;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)"></div>
<!-- /wp:group -->
