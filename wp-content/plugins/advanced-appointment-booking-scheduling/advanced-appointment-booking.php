...
function adv_app_book_admin_notice_with_html() {
    ...
    <div class="notice is-dismissible adv-app-book">
        <div class="adv-app-book-notice-banner-wrap" style="background-image: url(<?php echo esc_url(plugins_url('includes/images/ban-plain.png', __FILE__)); ?>)">
            <div class="adv-app-book-notice-heading">
              <h1 class="adv-app-book-main-head"><?php echo esc_html('WordPress Theme Bundle');?></h1>
              <p class="adv-app-book-sub-head"><span><?php echo esc_html('100+');?></span><?php echo esc_html('  Premium WordPress Themes in 1 Bundle ');?></p>
                <div class="adv-app-book-notice-btn">
                    <a class="adv-app-book-buy-btn" target="_blank" href="<?php echo esc_url( ABP_MAIN_URL . 'products/wordpress-theme-bundle' ); ?>"><?php echo esc_html('Buy Now');?></a>
                </div>
            </div>
        </div>
    </div>
