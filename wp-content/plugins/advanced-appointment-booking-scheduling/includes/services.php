    ...
    foreach ($services as $service) {
        echo '<tr>
            ...
            <td>
                ...
                <a href="' . admin_url('admin.php?page=appointment-bookings&tab=services&edit=1&id=' . esc_attr($service->id)) . '" class="button button-primary">Edit</a>

                <form method="POST" style="display:inline; margin-left: 5px;">
                    <input type="hidden" name="delete_service_id" value="' . esc_attr($service->id) . '">
                    ' . wp_nonce_field("delete_service", "_wpnonce", true, false) . '
